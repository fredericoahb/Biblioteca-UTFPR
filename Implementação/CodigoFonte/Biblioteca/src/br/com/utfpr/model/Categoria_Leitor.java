...
public class Categoria_Leitor implements Serializable{
	...
	@Column (name="dias_obra_categoria_leitor")
	private Integer dias_obra_categoria_leitor;
	...
	public Integer getDias_obra_categoria_leitor() {
		return dias_obra_categoria_leitor;
	}

	public void setDias_obra_categoria_leitor(Integer dias_obra_categoria_leitor) {
		this.dias_obra_categoria_leitor = dias_obra_categoria_leitor;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((dias_obra_categoria_leitor == null) ? 0 : dias_obra_categoria_leitor.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (descricao_categoria_leitor == null) {
			...
			return false;
		if (dias_obra_categoria_leitor == null) {
			if (other.dias_obra_categoria_leitor != null)
				return false;
		} else if (!dias_obra_categoria_leitor.equals(other.dias_obra_categoria_leitor))
			return false;
