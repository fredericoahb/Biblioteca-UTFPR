...
public class Categoria_Obra implements Serializable{
	...
	public Double getMulta_dia_categoria_obra() {
		return multa_dia_categoria_obra;
	}

	public void setMulta_dia_categoria_obra(Double multa_dia_categoria_obra) {
	...
	public int hashCode() {
		...
		result = prime * result + ((multa_dia_categoria_obra == null) ? 0 : multa_dia_categoria_obra.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (id_categoria_obra == null) {
			...
			return false;
		if (multa_dia_categoria_obra == null) {
			if (other.multa_dia_categoria_obra != null)
				return false;
		} else if (!multa_dia_categoria_obra.equals(other.multa_dia_categoria_obra))
			return false;
